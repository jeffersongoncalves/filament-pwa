...
![Filament PWA](https://raw.githubusercontent.com/jeffersongoncalves/filament-pwa/2.x/art/jeffersongoncalves-filament-pwa.png)
...
[![GitHub Tests Action Status](https://img.shields.io/github/actions/workflow/status/jeffersongoncalves/filament-pwa/run-tests.yml?branch=2.x&label=tests&style=flat-square)](https://github.com/jeffersongoncalves/filament-pwa/actions?query=workflow%3Arun-tests+branch%3A2.x)
[![GitHub Code Style Action Status](https://img.shields.io/github/actions/workflow/status/jeffersongoncalves/filament-pwa/fix-php-code-style-issues.yml?branch=2.x&label=code%20style&style=flat-square)](https://github.com/jeffersongoncalves/filament-pwa/actions?query=workflow%3A"Fix+PHP+code+styling"+branch%3A2.x)
...
```bash
composer require jeffersongoncalves/filament-pwa:^2.0
```
